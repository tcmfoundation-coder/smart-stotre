    ...
    <div className="min-h-screen bg-background transition-colors duration-300">
      ...
      <main className="p-8">
        <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 rounded-[2rem] p-8 mb-10 flex items-center space-x-6 shadow-sm">
          ...
          <div>
            <h2 className="text-xl font-black text-foreground uppercase tracking-tight">WhatsApp Protocol</h2>
        ...
        <div className="bg-card rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-border overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-lg font-bold text-foreground mb-2">Failed to load WhatsApp orders</p>
              <button
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-lg font-bold text-foreground mb-2">No WhatsApp orders found</p>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-muted/50 border-b border-border">
                    ...
                    <th className="text-left py-6 px-8 text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em]">Sender Profile</th>
                    <th className="text-left py-6 px-8 text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em]">Procurement</th>
                    <th className="text-left py-6 px-8 text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em]">Net Value</th>
                    <th className="text-left py-6 px-8 text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em]">Payment</th>
